...
from .forms import LoginForm, RegistrationForm, EventForm, BookingForm
...
def event_details():
    ...
    return render_template('event_details.html', login_form=login_form, booking_form=booking_form)
